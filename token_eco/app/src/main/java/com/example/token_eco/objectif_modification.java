...
public class objectif_modification extends menu_handler implements NavigationView.OnNavigationItemSelectedListener {

    private EditText titreObjectif, description, nbJeton;
    private String idO, nom_imageJeton;
    private ImageView imageJeton;
    private DatabaseReference enfantExiste, drSync, objectifs;
    private ValueEventListener eventEnfantExiste, enventObjectif, eventSync;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_objectif_modification);
        Button button_modifier_objectif = findViewById(R.id.button_modifier_objectif);
        titreObjectif = findViewById(R.id.modification_objectif_titre_comportement);
        nbJeton = findViewById(R.id.modification_objectif_nombre_jeton);
        description = findViewById(R.id.modification_objectif_description);
        imageJeton = findViewById(R.id.image_jeton_modification);
        ...
        objectifs = fh.getDatabaseReferenceEnfant(objectif_modification.this).child("objectifs").child(idO);
        afficherImage();
        afficherObjectif();
        ...
        button_modifier_objectif.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                modifierObjectif();
                try {
    ...
    public void afficherImage(){
        objectifs.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    public void afficherObjectif(){
        enventObjectif = new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                titreObjectif.setHint("titre : " + dataSnapshot.child("titre").getValue(String.class));
                description.setHint("description : "+dataSnapshot.child("description").getValue(String.class));
                nbJeton.setHint("jetons à obtenir : "+ dataSnapshot.child("jetonsAObtenir").getValue(Integer.class));
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
        ...
        objectifs.addValueEventListener(enventObjectif);
    }

    public void modifierObjectif(){
        if(titreObjectif.length() != 0){
            objectifs.getParent().addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if(titres.contains(titreObjectif.getText().toString().toLowerCase().trim())){
                        ...
                        objectifs.child("titre").setValue(titreObjectif.getText().toString());
                        titreObjectif.setText(null);
                    }
                }
                @Override
                public void onCancelled(@NonNull DatabaseError databaseError) {
        ...
        if(description.length() != 0){
            objectifs.child("description").setValue(description.getText().toString());
            description.setText(null);
        }
        if(nbJeton.length() != 0){
            AlertDialog.Builder ad = new AlertDialog.Builder(objectif_modification.this ,R.style.Theme_AppCompat_Light_Dialog_Alert)
                    .setTitle("Attention !")
                    .setMessage("Changer le nombre de jetons à obtenir supprime la progression de l'enfant.")
                    .setPositiveButton("changer", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            objectifs.child("jetonsAObtenir").setValue(Integer.parseInt(nbJeton.getText().toString()));
                            objectifs.child("jetonsObtenus").setValue(0);
                            nbJeton.setText(null);
                        }
    ...
    protected void onDestroy() {
        ...
        objectifs.removeEventListener(enventObjectif);
        ...
        btn_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!getApplicationContext().getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA_ANY)) {
                    Toast.makeText(objectif_modification.this, "Vous n'avez pas de caméra", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void prendrePhoto(){
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(objectif_modification.this, "Impossible de prendre une photo", Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if (mJetonUri != null) {
            ...
            uploadTask2.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(objectif_modification.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void demandePermissonPourLecture() {
        ActivityCompat.requestPermissions(objectif_modification.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, READ_PERMISSION_CODE);
    }
    private void demandePermissonPourCamera() {
        ActivityCompat.requestPermissions(objectif_modification.this, new String[]{Manifest.permission.CAMERA}, CAMERA_PERMISSION_CODE);
    }
    private void demandePermissonPourEcriture() {
        ActivityCompat.requestPermissions(objectif_modification.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_PERMISSION_CODE);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode == READ_PERMISSION_CODE){
            if(grantResults.length>0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                Toast.makeText(objectif_modification.this, "permission accordée", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(objectif_modification.this, "permission refusée", Toast.LENGTH_SHORT).show();
            }
        }
